"""Bach Hoa Xanh scraper — HTTP + BeautifulSoup."""
...
class BachHoaXanhScraper(BaseScraper):
    site_name = "bachhoaxanh"
    category_urls = {
        "sua":      f"{BASE_URL}/sua-va-san-pham-tu-sua",
        "ruou-bia": f"{BASE_URL}/ruou-bia-do-uong",
        "thuoc-la": f"{BASE_URL}/thuoc-la",
    }
